...
public class Config {
    ...
    public static final List<Department> DEPARTMENT_LIST = Arrays.asList(
        ...
        new Department("Kiểm soát TTHC", "2"),
        new Department("Nội vụ, Y tế, Văn hóa - Xã hội, Khoa học - Công nghệ, Giáo dục - Đào tạo, 
Tôn giáo", "3"),
    ...
    public static final List<String> DEPARTMENTS = Arrays.asList(
        "Tư pháp - Hộ tịch, Thanh tra", "Kiểm soát thủ tục hành chính", "Nội vụ, Y tế, Văn hóa - Xã hội, Khoa học - Công nghệ, Giáo dục - Đào tạo, 
Tôn giáo","Xây Dựng", "Nông Nghiệp và Môi Trường",
